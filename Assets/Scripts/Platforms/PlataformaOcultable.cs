...
{
    public float delayTime = 1f; // Tiempo de demora en segundos antes de desaparecer.
    public float tiempoOcultas = 2f; // Tiempo de demora en segundos antes de desaparecer.
    ...
    void DisappearPlatform()
    {
        ...
        // Restablecer la plataforma despu�s de un breve per�odo de tiempo.
